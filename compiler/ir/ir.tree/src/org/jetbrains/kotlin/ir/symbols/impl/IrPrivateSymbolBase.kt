...
abstract class IrBindableSymbolBase<out D : DeclarationDescriptor, B : IrSymbolOwner>(descriptor: D) :
    ...
    override fun bind(owner: B) {
        // TODO: uncommenting the check leads to exceptions on script lowering, check if this is ok to remove the check, or something is wrong with script processing
//        if (_owner == null) {
            _owner = owner
//        } else {
